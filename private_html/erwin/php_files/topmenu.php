...
$sql = "SELECT menu_item_name FROM $dbmenuitem WHERE menu_name = 'Top' ORDER BY menu_order";
...
$arrlenght=count($ar_menuitemname)
...
for($x=0;$x<$arrlength;$x++)
  {
      echo '<div id="id'.$ar_menuitemname[$x]. '" class="cl_title_mid">'.$ar_menuitemname[$x].'<br><p class="cl_centre">Erwin '.$menu_name.'</p><br></div>';
      echo '<li><a href="#id'.$ar_menuitemname[$x].'">'.$ar_menuitemname[$x].'</a></li>';
  }
